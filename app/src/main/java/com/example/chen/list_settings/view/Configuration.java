package com.example.chen.list_settings.view;
...
public class Configuration implements Cloneable {
	...
	static class Default {
		static int DEFAULT_OFF_COLOR = Color.parseColor("#999999");
		static int DEFAULT_ON_COLOR = Color.parseColor("#5baa66");
